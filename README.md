...
[官网](https://linux503.github.io/ZipX/) · [下载 DMG](https://linux503.github.io/ZipX/downloads/ZipX-1.2.5-Universal.dmg) · [Releases](https://github.com/linux503/ZipX/releases)
...
| 能力 | 说明 |
| --- | --- |
| 压缩 / 解压 | ZIP、7Z、RAR 开箱即用（含 RAR 压缩 / 解压） |
| 预览 | 不解压查看包内文件列表 |
...
> RAR 引擎（`rar` / `unrar`）已内置 Universal 二进制，遵循 RARLab 许可，详见 `Resources/bin/RAR-LICENSE.txt`。
...
1. 打开官网下载：[ZipX 1.2.5 Universal.dmg](https://linux503.github.io/ZipX/downloads/ZipX-1.2.5-Universal.dmg)
